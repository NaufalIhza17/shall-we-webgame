...
export function CollaborativeApp({ roomId }: { roomId: string }) {
  ...
  return (
    <div className="w-full h-screen flex flex-col justify-center items-center">
      <div className="flex items-center gap-2">
        ...
        <button onClick={handleCopy} className="p-1 group">
          <svg
            width="20px"
            height="20px"
            viewBox="0 0 24 24"
            ...
            className="fill-white group-hover:fill-white/90 group-active:fill-white/80"
          >
      ...
      <h3>{others.length + 1} people are in the Room</h3>
